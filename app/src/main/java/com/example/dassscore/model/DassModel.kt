package com.example.dassscore.model
...
data class DassQuestion(val id: Int, val text: String, val category: DassCategory)
...
val questions =
        listOf(
                ...
                DassQuestion(
                        7,
                        "I found it hard to have energy for things",
                        DassCategory.DEPRESSION
                ),
